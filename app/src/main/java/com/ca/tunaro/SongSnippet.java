...
public class SongSnippet {
    ...
    public SongSnippet(String songId, long snippetNo, String title, long startTime, long endTime, boolean includeInRankings) {
        this.songId = songId;
    ...
    public SongSnippet(long id, String songId, long snippetNo, String title, long startTime, long endTime, boolean includeInRankings) {
        this.id = id;
        this.songId = songId;
        this.snippetNo = snippetNo;
        this.title = title;
